    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-header">
        ...
        <div class="card-tools">
          <a href="{{asset('admin/consultorios/create')}}" class="btn btn-primary">
            Registrar nuevo
          </a>
        </div>
      </div>
...
<tr>
    ...
    <td style="text-align: center">
        <div class="btn-group">
            ...
            <a href="{{asset('admin/consultorios/'.$consultorio->id)}}" class="btn btn-info btn-sm">
                <i class="bi bi-eye"></i>
            </a>

            <a href="{{asset('admin/consultorios/'.$consultorio->id.'/edit')}}" class="btn btn-success btn-sm">
                <i class="bi bi-pencil"></i>
            </a>

            <a href="{{ asset('admin/consultorios/'.$consultorio->id.'/confirm-delete') }}" 
