      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/pacientes/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Creación de pacientes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/pacientes')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/consultorios/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Creación de consultorios</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/consultorios')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/doctores/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Creación de doctores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/doctores')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{asset('admin/horarios/create')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Creación de horarios</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{asset('admin/horarios')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="{{ asset('admin/reservas/create') }}" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
        ...
        <li class="nav-item">
            <a href="{{ asset('admin/reservas') }}" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
...
<li class="nav-item">
    ...
    <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
            <a href="{{ asset('roles/create') }}" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>Crear rol</p>
            </a>
        </li>
...
<li class="nav-item">
    <form action="{{ route('logout') }}" method="POST">
        ...
        <button type="submit"
                class="nav-link border-0 bg-danger text-white w-100 text-left">
